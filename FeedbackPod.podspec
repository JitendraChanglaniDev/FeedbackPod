...
s.pod_target_xcconfig = {'SWIFT_INCLUDE_PATHS' => '$(SRCROOT)/FeedbackPod/FeedbackPod/Zip/minizip/**','LIBRARY_SEARCH_PATHS' => '$(SRCROOT)/FeedbackPod/FeedbackPod/', 'SWIFT_OBJC_BRIDGING_HEADER' => '${SRCROOT}/FeedbackPod/FeedbackPod/Zip/minizip/FeedbackPod-Bridging-Header.h'}
